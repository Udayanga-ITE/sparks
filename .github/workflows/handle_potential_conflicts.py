...
def get_pr_json(pr_num):
    return requests.get(f'https://api.github.com/repos/sparkspay/sparks/pulls/{pr_num}').json()
...
def main():
    ...
    for conflict in conflictPrs:
        ...
        pre_mergeable = requests.get(f'https://github.com/sparkspay/sparks/branches/pre_mergeable/{our_pr_label}...{conflict_pr_label}')
