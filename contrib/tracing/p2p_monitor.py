...
""" Interactive sparksd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Sparks Core can enable. It uses BCC
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("USAGE:", sys.argv[0], "path/to/sparksd")
        exit()
    path = sys.argv[1]
    main(path)
