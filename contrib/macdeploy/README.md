...
When complete, it will have produced `Sparks-Core.zip`.
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/sparkspay/sparks-detached-sigs).
