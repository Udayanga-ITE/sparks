...
""" Tests the utxocache:* tracepoint API interface.
    See https://github.com/sparkspay/sparks/blob/develop/doc/tracing.md#context-utxocache
"""
...
class UTXOCacheTracepointTest(BitcoinTestFramework):
    ...
    def test_uncache(self):
        ...
        https://github.com/sparkspay/sparks/blob/develop/doc/tracing.md#tracepoint-utxocacheuncache
        """
    ...
    def test_add_spent(self):
        """ Tests the utxocache:add utxocache:spent tracepoint API
            See https://github.com/sparkspay/sparks/blob/develop/doc/tracing.md#tracepoint-utxocacheadd
            and https://github.com/sparkspay/sparks/blob/develop/doc/tracing.md#tracepoint-utxocachespent
        """
    ...
    def test_flush(self):
        """ Tests the utxocache:flush tracepoint API.
            See https://github.com/sparkspay/sparks/blob/develop/doc/tracing.md#tracepoint-utxocacheflush"""
