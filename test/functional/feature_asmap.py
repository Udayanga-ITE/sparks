...
5. `sparksd -asmap` restart with an addrman containing new and tried entries

6. `sparksd -asmap` with no file specified and a missing default asmap file

7. `sparksd -asmap` with an empty (unparsable) default asmap file
...
class AsmapTest(BitcoinTestFramework):
    ...
    def test_default_asmap(self):
        ...
        for arg in ['-asmap', '-asmap=']:
            self.log.info(f'Test sparksd {arg} (using default map file)')
            self.stop_node(0)
    ...
    def test_asmap_interaction_with_addrman_containing_entries(self):
        self.log.info("Test sparksd -asmap restart with addrman containing new and tried entries")
        self.stop_node(0)
        shutil.copyfile(self.asmap_raw, self.default_asmap)
