...
void SparksPostChainstateSetupClose(NodeContext& node)
{
#ifdef ENABLE_WALLET
...
TestingSetup::~TestingSetup()
{
    ...
    // SparksChainstateSetup() is called by LoadChainstate() internally but
    ...
    CChainState& chainstate)
{
    ...
    CBlock block = BlockAssembler(chainstate, m_node, empty_pool, chainparams).CreateNewBlock(scriptPubKey, *m_node.sporkman)->block;
