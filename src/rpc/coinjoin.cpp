...
// Copyright (c) 2019-2025 The Sparks Core developers
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    bool result = cj_clientman->DoAutomaticDenominating(chainman, connman, mempool, *node.sporkman);
...
{ //  category               actor (function)
  //  ---------------------  -----------------------
    { "sparks",                &getcoinjoininfo,        },
#ifdef ENABLE_WALLET
    { "sparks",                &coinjoin,               },
    { "sparks",                &coinjoin_reset,         },
    { "sparks",                &coinjoin_start,         },
    { "sparks",                &coinjoin_stop,          },
    { "sparks",                &coinjoinsalt,           },
    { "sparks",                &coinjoinsalt_generate,  },
    { "sparks",                &coinjoinsalt_get,       },
    { "sparks",                &coinjoinsalt_set,       },
