...
Version 2 of the Sparks P2P protocol / BIP324, which enables encryption of the P2P protocol,
has been enabled by default in this version. This was initially introduced in Sparks Core
...
You can view [the list of bad ports here](https://github.com/sparkspay/sparks/blob/v22.1.x/doc/p2p-bad-ports.md).

Tests
-----

- Command line arguments `-dip8params` and `-bip147height` are removed in favor of `-testactivationheight`. (sparks#6325)
...
- The top-level fee fields `fee`, `modifiedfee`, `ancestorfees` and `descendantfees`
  ...
  fields in the `fees` object are denominated in Sparks.
...
- Improved GUI responsiveness for large wallets. (sparks#6457)
...
[set-of-changes]: https://github.com/sparkspay/sparks/compare/v22.0.0...sparkspay:v22.1.0
