...
This version addressed a problem affecting certain Sparks-specific connection types, including mixing and masternode probes, when
downgrading from v2 to v1 connections. This resulted in increased connection count and load for masternodes. (sparks#6574)

Minor QT Coinjoin Fixes
-----------------------

- Avoid leaking CJ related balances in discrete mode (sparks#6566)
...
[set-of-changes]: https://github.com/sparkspay/sparks/compare/v22.1.0...sparkspay:v22.1.1
