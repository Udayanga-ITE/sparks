...
Assumeutxo is a feature that allows fast bootstrapping of a validating sparksd
...
considered active. This is the "traditional" mode of operation for sparksd.
...
**Failure consideration:** if sparksd unexpectedly halts after `m_stop_use` is set on
...
### Sparksd restarts sometime after snapshot validation has completed

When sparksd initializes again, what began as the snapshot chainstate is now
